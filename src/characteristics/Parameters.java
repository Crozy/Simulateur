...
public class Parameters {
  ...
  public static final String teamBMainBotBrainClassName = "algorithms.Combinaison"; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamBSecondaryBotBrainClassName = "algorithms.Combinaison"; //class given by name; is supposed to extends robotsimulator.Brain
